                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Batas Lamaran: ' +
                                        _filteredLowongan[index].tanggalExpired,
                                    style: TextStyle(
                                        color: red,
                                        fontSize: 12.0,
                                        fontWeight: FontWeight.bold),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            launch(
                                                'mailto:${_filteredLowongan[index].email}');
                                          },
                                          child: Text(
                                            'Email: ' +
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            launch(
                                                'https://www.google.com/maps/search/?api=1&query=${_filteredLowongan[index].alamatKantor}');
                                          },
                                          child: Text(
                                            'Alamat: ' +
                                                _filteredLowongan[index]
